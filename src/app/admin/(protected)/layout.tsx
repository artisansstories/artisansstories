...
function AdminLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  function NavLink({ item }: { item: typeof NAV_ITEMS[0] }) {
    ...
    return (
      ...
      >
        <span style={{ flexShrink: 0, color: isActive ? "#8B6914" : "#8a7060" }}>
          <Icon size={18} />
        </span>
        {item.label}
      </a>
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
        ...
        <div style={{ padding: "20px 16px 12px", borderBottom: "1px solid #ede8df" }}>
          ...
          <p style={{ fontSize: 11, color: "#b09878", fontFamily: "'Inter',sans-serif", letterSpacing: "0.06em", textTransform: "uppercase", marginTop: 6 }}>
            Admin Panel
          </p>
        </div>
        ...
        <div style={{ padding: "12px 16px", borderTop: "1px solid #ede8df" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ minWidth: 0 }}>
              <p style={{ fontSize: 13, fontWeight: 600, color: "#3a2e24", fontFamily: "'Inter',sans-serif", margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {user?.name ?? "Admin"}
              </p>
              <p style={{ fontSize: 11, color: "#9a876e", fontFamily: "'Inter',sans-serif", margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {user?.email}
              </p>
            </div>
          </div>
          <button
            ...
            style={{ width: "100%", padding: "8px 12px", borderRadius: 8, border: "1px solid #e0d5c5", background: "transparent", color: "#7a5c3a", fontSize: 13, fontFamily: "'Inter',sans-serif", cursor: "pointer", transition: "background 0.15s", textAlign: "center" }}
      ...
      <div style={{ display: "flex", minHeight: "100dvh" }}>
        ...
        >
          <button
            ...
            style={{ position: "absolute", top: 16, right: 16, background: "transparent", border: "none", cursor: "pointer", color: "#8a7060", padding: 4 }}
          >
            <IconX size={20} />
          </button>
          <SidebarContent />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <header style={{
            ...
            <button
              ...
              style={{ background: "transparent", border: "none", cursor: "pointer", color: "#6b5540", padding: 6, display: "flex", alignItems: "center" }}
            ...
            {/* Store name (desktop) */}
            <span style={{ fontSize: 16, fontWeight: 600, color: "#3a2e24", fontFamily: "'Cormorant Garamond',serif", letterSpacing: "0.02em" }} className="admin-storename">
              Artisans Stories
            </span>
          ...
          {NAV_ITEMS.filter(i => i.mobileShow).map(item => {
            ...
            return (
              <a key={item.href} href={item.href} style={{
                ...
                textDecoration: "none",
                color: isActive ? "#8B6914" : "#9a8070",
                gap: 3,
                minWidth: 0,
              }}>
                <Icon size={20} />
                <span style={{ fontSize: 10, fontFamily: "'Inter',sans-serif", fontWeight: isActive ? 600 : 400, letterSpacing: "0.02em" }}>
                  {item.label}
                </span>
              </a>
            );
