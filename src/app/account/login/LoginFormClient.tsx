...
function LoginForm({ logoUrl, storeName = "Artisans' Stories" }: LoginFormClientProps) {
...
export default function LoginFormClient({ logoUrl, storeName }: LoginFormClientProps) {
  return (
    <Suspense fallback={<div />}>
      <LoginForm logoUrl={logoUrl} storeName={storeName} />
    </Suspense>
  );
}
