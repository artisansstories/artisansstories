  ...
  return (
    <>
      ...
      <main style={{
        ...
        {/* Background image with split design on desktop */}
        <div className="hero-split" style={{
          ...
          {/* Left side: Artisan work (background) */}
          <div style={{
            position:"relative",
            flex:1,
            minHeight:"50vh",
            ...
            <div style={{
              ...
              background:"linear-gradient(to bottom, rgba(10,6,3,0.88) 0%, rgba(10,6,3,0.68) 40%, rgba(10,6,3,0.75) 100%)",
            }}/>
            {/* Warm glow */}
            <div style={{
              position:"absolute", inset:0,
            ...
            {/* Content overlay on mobile, side-by-side on desktop */}
            <div style={{
              position:"absolute",
              inset:0,
              display:"flex",
              ...
              <div className="a2" style={{
                marginBottom:"clamp(24px,4vw,36px)",
                padding:"clamp(14px,2.5vw,20px) clamp(20px,4vw,36px)",
              ...
              {/* Anna's portrait - circular with warm border */}
              ...
              <div className="a3" style={{
                ...
                <h2 style={{
                  ...
                  lineHeight:1.4,
                  marginBottom:"12px",
                }}>Curator of Stories, Keeper of Craft</h2>
                <p style={{
                  fontFamily:"'Cormorant Garamond',Georgia,serif",
                  ...
                  Every artisan has a story. Every craft holds generations of tradition. I'm Anna, and I'm here to bring those stories—and those beautiful handmade pieces—directly to you.
                </p>
              </div>
              ...
              <p className="a4" style={{
                ...
                Every product has a story, and we are so excited to share those products and stories with you…
              </p>
              ...
              {/* Email form */}
              <div className="a5" style={{ width:"100%", maxWidth:"420px" }}>
                {status === "success" ? (
                  <div style={{
                    background:"rgba(255,255,255,0.08)",
                    ...
                    <p style={{
                      ...
                      fontSize:"clamp(17px,3.5vw,20px)", fontStyle:"italic",
