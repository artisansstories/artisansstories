...
<head>
  ...
  <title>Return Update — ${orderNumber}</title>
</head>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 16px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding: 40px 40px 28px; text-align: center; border-bottom: 1px solid #ede8df;">
              <div style="width: 64px; height: 64px; background: #fee2e2; border: 2px solid #dc2626; border-radius: 50%; margin: 0 auto 18px;">
          ...
          <tr>
            <td style="padding: 28px 40px; background: #faf7f2; border-bottom: 1px solid #ede8df;">
              ...
              <div style="padding: 16px 20px; background: #fff; border: 1px solid #ede8df; border-left: 4px solid #dc2626; border-radius: 4px;">
          ...
          <tr>
            <td style="padding: 24px 40px; background: #faf7f2; border-top: 1px solid #ede8df; text-align: center;">
              <p style="margin: 0 0 10px; font-size: 15px; color: #3a2e24; font-weight: 600;">
                Questions or concerns?
              </p>
              <p style="margin: 0 0 16px; font-size: 14px; color: #7a6852;">
                We understand this may be disappointing. Please reach out to us and we'll do our best to help.
              </p>
              <a href="mailto:hello@artisansstories.com"
                style="display: inline-block; background: linear-gradient(135deg, #8B6914 0%, #C9A84C 100%); color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; padding: 12px 28px; border-radius: 8px; letter-spacing: 0.5px;">
                Contact Us
              </a>
            </td>
          </tr>
          ...
          <!-- Footer note -->
          <tr>
            <td style="padding: 20px 40px; text-align: center; border-top: 1px solid #ede8df;">
              <p style="margin: 0; font-size: 13px; color: #9a876e;">
                This update was sent to <strong style="color: #3a2e24;">${email}</strong>
              </p>
            </td>
          </tr>
